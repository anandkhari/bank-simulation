  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-start overflow-hidden">
      ...
      <div className="pt-16 text-center text-white">
        <h1 className="text-3xl font-light">Secure Sign-in</h1>
      </div>

      {/* SUCCESS CARD */}
      <div className="mt-12 bg-[#f4f4f4] w-[90%] max-w-[600px] h-[550px] flex flex-col items-center justify-center relative shadow-lg">
