      ...
      <div className="bg-gray-100 border-b">
        <div className="max-w-6xl mx-auto flex gap-8 px-4 text-sm">
          <button
            ...
            className={`py-3 border-[var(--client-brand)] font-medium transition-all ${
              isActive("/client/dashboard") 
                ? "border-b-2 text-[var(--client-brand)]" 
                : "text-gray-600 hover:text-[var(--client-brand)]"
            }`}
          >
            Accounts Summary
          </button>
          ...
          <button
            ...
            className={`py-3 border-[var(--client-brand)] font-medium transition-all ${
              isActive("/client/accountsdocuments") 
                ? "border-b-2 text-[var(--client-brand)]" 
                : "text-gray-600 hover:text-[var(--client-brand)]"
            }`}
          >
